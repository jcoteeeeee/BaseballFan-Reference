class GamesController < ApplicationController 
    ...
    def update 
        game = Game.find_by(id: params[:id])
        game.update(date: params[:date], result: params[:result], score: params[:score], opponent: params[:opponent], location: params[:location], st_pitcher: params[:st_pitcher], note: params[:note])  
        render json: game 
    end 
