...
# puts "seeding user"
# # User.create(first_name: 'NameOne', last_name: 'LastNameOne', username: 'userOne', email: 'example@gmail.com', password: '12345', fav_team: 'Mets' )    
# # User.create(first_name: 'NamtTwo', last_name: 'LastNameTwo', username: 'userTwo', email: 'fakeemail@gmail.com', password: 'abcde', fav_team: 'Phillies')     
# # User.create(first_name: 'NameThree', last_name: 'LastNameThree', username: 'userThree', email: 'nothing@gmail.com', password: '11111', fav_team: 'Red Sox')     
# # User.create(first_name: 'NameFour', last_name: 'LastNameFour', username: 'userFour', email: 'noemail@gmail.com', password: '12121', fav_team: 'Twins')     
# # User.create(first_name: 'NameFive', last_name: 'LastNameFive', username: 'userFive', email: 'gmail@gmail.com', password: '00000', fav_team: 'Blue Jays')
