    ...
    return(
        <div>
            ...
            <form id='addgame-form' onSubmit={handleAddGameSubmit}>
                <label>Date</label>
                <input value={date} id='add-date' type='date' name='add_date' onChange={(e) => setDate(e.target.value)}/> {/* make required */}
                <br />
                <label>Result</label>
                ...
                <input value={opponent} id='add-opponent' type='text' name='add_opp' onChange={(e) => setOpponent(e.target.value)}/>
                <br/>
